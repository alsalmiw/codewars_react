...
const LoginPage = () => {
    ...
    let { codewarsName, setCodewarsName, setCohortName,storedCodewarsName, SetStoredCodwarsName, userId, setUserId, isAdmin, setIsAdmin, isDeleted, setIsDeleted, token, setToken } = useContext(UserContext);
