        ...
        <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
            <Container fluid className='ms-5 me-5' >
                ...
                <Nav className="me-auto">
                    {token != null && isAdmin==false? <Nav.Link className='headerText' as={Link} to="/dashboard">Dashboard</Nav.Link> : null}
                </Nav>
                <Nav>
                    {token != null && isAdmin? <Nav.Link className='headerText' as={Link} to="/admin">Admin</Nav.Link> : null}
                    {token == null ?
